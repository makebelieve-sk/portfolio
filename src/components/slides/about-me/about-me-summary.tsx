...
export default function AboutMeSummary() {
    ...
    return (
        <>
            ...
            <ul
                className="ml-[clamp(2px,0.3125cqw,6px)] list-none space-y-[clamp(4px,0.711cqw,0.854rem)] p-0 font-sans font-medium leading-[1.21]"
                style={{
                    fontSize: "clamp(9px, 1.72cqw, 2.0625rem)",
                    marginTop: m.architectureLeadIn
                        ? "clamp(0.75rem, 2.188cqw, 2.625rem)"
                        : "clamp(1.5rem, 5.208cqw, 6.25rem)",
                }}
            >
